...
npm run serve
```
Ensuite dirigez vous vers l'URL <a name="discord-vuejs" href="localhost:8080/signin">localhost:8080/signin</a> afin d'arriver sur la page de connexion de l'application.
